...
class Plant:
    ...
    def __repr__(self):
        return f"Plant(type={self.type}, x={self.x}, y={self.y}, has_been_visited={self.has_been_visited}, perimeter={self.perimeter}, size={self.size})"
    ...
    for dx, dy in directions:
        ...
        if (adjacent_x, adjacent_y) in plants and plants[(adjacent_x, adjacent_y)].type == plant.type:
            ...
            if not plants[(adjacent_x, adjacent_y)].has_been_visited:
                ...
                plant.perimeter += plants[(adjacent_x, adjacent_y)].perimeter
